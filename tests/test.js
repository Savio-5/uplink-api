...
OAUTH2.accessToken = process.env.ACCESS_TOKEN; // Replace "ACCESS_TOKEN" with your actual token
...
const connectWebSocket = async (wsUrl) => {
  return new Promise((resolve, reject) => {
    ...
    //       data.last_price > 100
    //     ) {
    //       results.push(data.instrument_key);
    //     }
    //   })
    //   .on('end', () => {
